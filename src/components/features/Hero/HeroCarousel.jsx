...
const HeroCarousel = ({ currentQuote, nextQuote, prevQuote, fontSize, currentSlide, className = "" }) => {
  ...
  const { showQuotation, showSearchBar, showQuickLinks, widgetsEnabled } = useSettings();
  ...
  return (
    <div className={`${className} flex flex-col items-center justify-between h-[85vh] lg:h-full order-1 lg:order-2 relative z-10 w-full pb-20 lg:pb-8 pt-8`}>
