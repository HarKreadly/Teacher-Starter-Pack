...
const CardNav = ({
  ...
  return (
    <div
      className={`card-nav-container w-full max-w-[800px] mx-auto ${className}`}
    >
      <nav
        ref={navRef}
        className={`card-nav ${
      ...
      >
        <div className="card-nav-top absolute inset-x-0 top-0 h-[60px] flex items-center justify-between p-2 pl-[1.1rem] z-10">
          <div
        ...
        <div
          className={`card-nav-content absolute left-0 right-0 top-[60px] bottom-0 p-2 flex flex-col items-stretch gap-2 justify-start z-0 ${
            isExpanded
        ...
        >
          ...
          <div className="flex md:hidden items-center justify-center space-x-3 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg mb-2">
            <ThemeToggle />
            <LanguageSelector />
          </div>
